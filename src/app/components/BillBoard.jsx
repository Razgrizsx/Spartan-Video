...
export default async function BillBoard(){
   ...
   const {description, title, videourl, thumbnailurl} = data.data
       return( 
        <div className="relative h-[400px] w-full">
            ...
            <div className="absolute top-[50%] md:top-[4%] ml-4 md:ml-16">
                ...
                <div className="flex flex-row items-center mt-3 md:mt-4 gap-3">
                    ...
                    <button className="bg-white text-white bg-opacity-30 rounded-md py-1 md:py-2 px-2 md:px-4 w-auto text-xs lg:text-lg font-semibold flex flex-row items-center hover:bg-opacity-20"><AiOutlineInfoCircle className='mr-1'/> More Info</button>
                </div>
            </div>
        </div>
    )
